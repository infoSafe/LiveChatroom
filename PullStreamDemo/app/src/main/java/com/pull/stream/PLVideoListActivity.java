...
public class PLVideoListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.pull.stream.R.layout.activity_video_list);
        for (int i = 0; i < 5; ++i) {
    ...
    class VideoListAdapter extends RecyclerView.Adapter<VideoListAdapter.ViewHolder> {
        ...
        public VideoListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            PLVideoTextureView view = (PLVideoTextureView) LayoutInflater.from(parent.getContext()).inflate(com.pull.stream.R.layout.layout_video_list_item, parent, false);
