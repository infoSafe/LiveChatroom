...
public class SWCameraStreamingActivity extends Activity implements StreamingStateChangedListener, View.OnClickListener {
    ...
    private TextView tv_show_name,tv_message;
        ...
        RongIMClient.setOnReceiveMessageListener(new RongIMClient.OnReceiveMessageListener() {
            ...
            public boolean onReceived(Message message, int i) {
                ...
                if (messageContent instanceof ChatroomWelcome) {
                    ...
                    Log.d(TAG, "onReceived: ===>"+chatroomWelcome.getId());
                    tv_message.setText(chatroomWelcome.getId()+"  "+chatroomWelcome.getExtra().toString());
                }else if(messageContent instanceof TextMessage){
                    TextMessage textMessage = (TextMessage)messageContent;
                    tv_message.setText(textMessage.getContent());
                }
